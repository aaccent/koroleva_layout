...
const popupBtns = document.querySelectorAll('button[data-action="popup"]')
 ...
 * */
export function openPopup(name, target = null) {
    const activeHeader = document.querySelector('.header.active')
    const targetPopup = document.querySelector(`.popup[data-popup="${name}"]`)
 ...
 */
export function closeActivePopup(code) {
