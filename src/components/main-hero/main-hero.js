...
function createSVGCircle(container) {
...
void (function () {
    const mainHeroSlider = document.querySelector('.main-hero__slider')
    ...
    const circlesPreview = document.querySelectorAll('.main-hero__thumbs-slide')
    ...
    function activateCirclePreview() {
        ...
        const currentActiveCircle = document.querySelector('.main-hero__thumbs-slide._active')
...
//# sourceMappingURL=main-hero.js.map
