...
function addScrollContent(number = 1) {
    const titles = document.querySelectorAll('.gift-card__scroll-content')
    const scrollContainer = document.querySelector('.gift-card__scroll')
    ...
    const extraTitle = titles[0].cloneNode(true)
...
void (function () {
    ...
    const openGiftCardPopup = document.querySelector('.gift-card__button')
    openGiftCardPopup?.addEventListener('click', () => {
        const activeValue = document.querySelector('.gift-card__list-item._active')
