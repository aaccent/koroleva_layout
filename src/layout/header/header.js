...
void (function () {
    ...
    if (isMobile) {
        ...
        const catalogBack = document.querySelector('.header-catalog__back')
        const itemSubmenu = document.querySelectorAll('.header-menu__item:has(.header-menu__item-submenu)')
        const submenuBack = document.querySelectorAll('.header-menu__item-submenu-back')
        const catalogItems = document.querySelectorAll('.header-catalog__item')
