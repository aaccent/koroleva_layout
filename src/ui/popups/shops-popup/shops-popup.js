import { createYMap, getCoordsFromDataset, setMapBounds } from 'features/maps/createYMap'
import { isMobile } from 'globals/adaptive'
void (async function () {
    const shopPopup = document.querySelector('.shops-popup')
    if (!shopPopup) return
    const shopsElements = Array.from(shopPopup.querySelectorAll('.shops__item'))
...
//# sourceMappingURL=shops-popup.js.map
