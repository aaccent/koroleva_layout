void (function () {
    const telBody = document.querySelector<HTMLElement>('.authorization-popup__tel')
    const codeBody = document.querySelector<HTMLFormElement>('.authorization-popup__code')
    ...
    telBody.addEventListener('form-sent', () => {
        const telValue = telBody.querySelector<HTMLInputElement>('input[name="tel"]')?.value
    ...
    const hiddenInput = codeBody.querySelector<HTMLInputElement>('input[type="hidden"]')
    const codeSentButton = codeBody.querySelector<HTMLButtonElement>('.authorization-popup__body-button')
    ...
    const codeInputs = document.querySelectorAll<HTMLInputElement>('.authorization-popup__code-item')
    let fullCode: string[] = new Array(codeInputs.length).fill('')
